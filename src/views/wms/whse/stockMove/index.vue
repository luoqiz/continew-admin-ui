...
const columns: ComputedRef<TableInstanceColumns[]> = computed(() => [
  ...
  { title: t('wms.whse.stock.move.field.stockInId'), dataIndex: 'stockInNo', slotName: 'stockInId' },
  { title: t('wms.whse.stock.move.field.stockOutId'), dataIndex: 'stockOutNo', slotName: 'stockOutId' },
