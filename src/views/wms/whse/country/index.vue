  ...
  <div class="table-page">
    ...
    >
      ...
      <template #action="{ record }">
        <a-space>
          <!-- <a-link v-permission="['wms:addr:detail']" @click="onDetail(record)">{{ $t('page.common.button.detail') }}</a-link> -->
...
import { type AddrResp, type WhseAddrQuery, deleteAddr, exportAddr, listAddr, listAddrCountry, listAddrStore } from '@/apis/wms'
...
const {
  ...
  search,
  handleDelete,
} = useTable((page) => listAddrCountry({ ...queryForm, ...page }), { immediate: true })
